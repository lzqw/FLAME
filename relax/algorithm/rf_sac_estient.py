...
from relax.network.rf_sac_estient import RFSACESTIENTNet, Diffv2Params
...
class RFSACESTIENT(Algorithm):

    def __init__(
        self,
        agent: RFSACESTIENTNet,
        params: Diffv2Params,
        *,
        gamma: float = 0.99,
        lr: float = 1e-4,
        ...
        def stateless_update(
            ...
            def cal_entropy():
                ...
                actions = jax.vmap(self.agent.get_action, in_axes=(0, None, None), out_axes=1)(keys, (policy_params, jax.lax.stop_gradient(log_alpha), q1_params, q2_params), obs)
