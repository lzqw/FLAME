...
def create_rf_sac_estient_net(
...
) -> Tuple[RFSACESTIENTNet, Diffv2Params]:
    ...
    net = RFSACESTIENTNet(q=q.apply, policy=policy.apply, num_timesteps=num_timesteps, num_timesteps_test=num_timesteps_test,
                act_dim=act_dim,
