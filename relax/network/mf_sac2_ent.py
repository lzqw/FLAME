...
class MFSAC2ENTNet:
    ...
    def get_action(self, key: jax.Array, policy_params: hk.Params, obs: jax.Array) -> jax.Array:
        ...
        act = act #+ jax.random.normal(noise_key, act.shape) * jnp.float32(0.001) * self.noise_scale
        return act
    def get_action_ent(self, key: jax.Array, policy_params: hk.Params, obs: jax.Array) -> Tuple[jax.Array, jax.Array]:
        ...
        noisy_act = act #+ jax.random.normal(noise_key, act.shape) * jnp.float32(0.001) * self.noise_scale
